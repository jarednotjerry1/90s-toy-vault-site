export function Newsletter() {
  return (
    <section className="py-16 md:py-20">
      <div className="rounded-xl border border-vault-border bg-vault-bg-secondary p-8 md:p-12 relative overflow-hidden" style={{ textAlign: 'center' }}>
        ...
        <p className="text-vault-text-secondary text-sm md:text-base mb-6" style={{ maxWidth: '28rem', marginLeft: 'auto', marginRight: 'auto' }}>
          New videos every day. The stories, the collections, the nostalgia.
        </p>
        <a
